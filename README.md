...
- `Self driven` = This file is the Main file it can be <b>excecuted anywhere(on Server or on Local Machine depending on your data size)</b> beacuse it is used for cleaning the data and training of ANN(Artificial Neural Network) model. Only thing you need do is to change data dir to your data dir which you had made from running above code(mk_training_data). 
<br></br>
Once the Execution of this file has been done you will get the training model (.h5 file) as the output in your working dir.
